...
- id: gatk_markduplicates_4_1_0_0
  ...
  - id: validation_stringency
    default: SILENT
  run: pre-processing.cwl.steps/gatk_markduplicates_4_1_0_0.cwl
  out:
  - id: out_alignments
  - id: output_metrics
...
- id: bwa_mem_bundle_0_7_15
  ...
  scatter:
  - input_reads
  run: pre-processing.cwl.steps/bwa_mem_bundle_0_7_15.cwl
  out:
  - id: aligned_reads
  - id: dups_metrics
...
- id: gatk_mergebamalignment_4_1_0_0
  ...
  run: pre-processing.cwl.steps/gatk_mergebamalignment_4_1_0_0.cwl
  out:
  - id: out_alignments
  sbg:x: -9
...
- id: gatk_samtofastq_4_1_0_0
  ...
  scatter:
  - in_alignments
  run: pre-processing.cwl.steps/gatk_samtofastq_4_1_0_0.cwl
  out:
  - id: out_reads
  - id: unmapped_reads
...
- id: gatk_sortsam_4_1_0_0
  ...
  - id: sort_order
    default: coordinate
  run: pre-processing.cwl.steps/gatk_sortsam_4_1_0_0.cwl
  out:
  - id: out_alignments
...
- id: gatk_setnmmdanduqtags_4_1_0_0
  ...
  - id: reference_sequence
    source: in_reference
  run: pre-processing.cwl.steps/gatk_setnmmdanduqtags_4_1_0_0.cwl
  out:
  - id: out_alignments
...
- id: gatk_baserecalibrator_4_1_0_0
  ...
  run: pre-processing.cwl.steps/gatk_baserecalibrator_4_1_0_0.cwl
  out:
  - id: out_bqsr_report
...
- id: gatk_createsequencegroupingtsv_4_1_0_0
  ...
  - id: ref_dict
    source: ref_dict
  run: pre-processing.cwl.steps/gatk_createsequencegroupingtsv_4_1_0_0.cwl
  out:
...
- id: gatk_gatherbqsrreports_4_1_0_0
  ...
  run: pre-processing.cwl.steps/gatk_gatherbqsrreports_4_1_0_0.cwl
  out:
...
- id: gatk_applybqsr_4_1_0_0
  ...
  scatter:
  - include_intervals_file
  run: pre-processing.cwl.steps/gatk_applybqsr_4_1_0_0.cwl
  out:
  - id: out_alignments
...
- id: gatk_gatherbamfiles_4_1_0_0
  ...
  - id: create_md5_file
    default: true
  run: pre-processing.cwl.steps/gatk_gatherbamfiles_4_1_0_0.cwl
  out:
  - id: out_alignments
  - id: out_md5
...
- id: samtools_view_1_9_cwl1_0
  ...
  scatter:
  - in_alignments
  run: pre-processing.cwl.steps/samtools_view_1_9_cwl1_0.cwl
  out:
  - id: out_alignments
...
- id: sbg_lines_to_interval_list_abr
  ...
  run: pre-processing.cwl.steps/sbg_lines_to_interval_list_abr.cwl
  out:
  - id: out_intervals
...
- id: sbg_lines_to_interval_list_br
  ...
  run: pre-processing.cwl.steps/sbg_lines_to_interval_list_br.cwl
  out:
  - id: out_intervals
...
- admin
sbg:createdBy: admin
sbg:createdOn: 1572002762
sbg:expand_workflow: false
sbg:id: |-
  admin/sbg-public-data/broad-best-practice-data-pre-processing-workflow-4-1-0-0/26
sbg:image_url: |-
  https://platform.sb.biodatacatalyst.nhlbi.nih.gov/ns/brood/images/admin/sbg-public-data/broad-best-practice-data-pre-processing-workflow-4-1-0-0/26.png
...
sbg:modifiedOn: 1612280633
sbg:original_source: |-
  https://api.sb.biodatacatalyst.nhlbi.nih.gov/v2/apps/admin/sbg-public-data/broad-best-practice-data-pre-processing-workflow-4-1-0-0/26/raw/
